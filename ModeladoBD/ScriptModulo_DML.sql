/* ==============================================================
   1. TABLAS PARAMÉTRICAS (REQUERIMIENTO 2.1 y 2.5)
...
INSERT INTO TipoContact (idTipoConta, descTipoConta) VALUES ('DIR', 'Dirección Física');
...
INSERT INTO TipoLugar (idTipoLugar, descTipoLugar) VALUES ('FIS', 'Fiscalía');
...
INSERT INTO FormaPago (idFormaPago, descFormaPago) VALUES ('TCR', 'Tarjeta de Crédito');
...
-- 2.5 Incluir 3 juzgados y 3 tribunales con jerarquía (Lugar) e Instancias
...
VALUES ('BOG01', 'CIU', NULL, 'Bogotá D.C.', 'Cundinamarca', '6010000', 'alcaldia@bogota.gov.co');

-- Insertamos 3 JUZGADOS (Hijos de Bogotá, Tipo 'JUZ')
INSERT INTO Lugar (codLugar, idTipoLugar, Lug_codLugar, nomLugar, direLugar, telLugar, emailLugar) 
...
-- Insertamos 3 TRIBUNALES (Hijos de Bogotá, Tipo 'TRI')
INSERT INTO Lugar (codLugar, idTipoLugar, Lug_codLugar, nomLugar, direLugar, telLugar, emailLugar) 
...
-- Insertamos la Fiscalía (Para que no falle el Caso Hipotético)
INSERT INTO Lugar (codLugar, idTipoLugar, Lug_codLugar, nomLugar, direLugar, telLugar, emailLugar) 
VALUES ('FIS01', 'FIS', 'BOG01', 'Fiscalía General', 'Bunker', '6011234', 'contacto@fiscalia.gov.co');

-- Insertar 3 Instancias
INSERT INTO Instancia (nInstancia) VALUES (1); -- Primera Instancia
INSERT INTO Instancia (nInstancia) VALUES (2); -- Segunda Instancia (Apelación)
INSERT INTO Instancia (nInstancia) VALUES (3); -- Casación

/* ==============================================================
   2. DEFINICIÓN DEL NEGOCIO (REQUERIMIENTOS 2.2 y 2.3)
   Especializaciones, Etapas, Impugnaciones y la Tabla de Configuración
   ============================================================== */
...
-- Catálogo único de Etapas Procesales
INSERT INTO EtapaProcesal (codEtapa, nomEtapa) VALUES ('IND', 'Indagación');
INSERT INTO EtapaProcesal (codEtapa, nomEtapa) VALUES ('IMP', 'Imputación');
...
INSERT INTO EtapaProcesal (codEtapa, nomEtapa) VALUES ('CON', 'Contestación');
...
INSERT INTO EtapaProcesal (codEtapa, nomEtapa) VALUES ('PRE', 'Presentación');
INSERT INTO EtapaProcesal (codEtapa, nomEtapa) VALUES ('TRA', 'Trámite urgente');
INSERT INTO EtapaProcesal (codEtapa, nomEtapa) VALUES ('FAL', 'Fallo');
INSERT INTO EtapaProcesal (codEtapa, nomEtapa) VALUES ('TIM', 'Trámite Impugnación'); -- Representa la etapa final de "Impugnación"

-- Impugnaciones
INSERT INTO Impugnacion (idImpugna, nomImpugna) VALUES ('NO', 'Sin Impugnación'); -- Para etapas normales
...
INSERT INTO Impugnacion (idImpugna, nomImpugna) VALUES ('RE', 'Reposición');
INSERT INTO Impugnacion (idImpugna, nomImpugna) VALUES ('RV', 'Revisión');
INSERT INTO Impugnacion (idImpugna, nomImpugna) VALUES ('UN', 'Unificación de jurisprudencia');
INSERT INTO Impugnacion (idImpugna, nomImpugna) VALUES ('IM', 'Impugnación de tutela');
INSERT INTO Impugnacion (idImpugna, nomImpugna) VALUES ('RC', 'Revisión constitucional');

-- 2.3 Incluir en la tabla Especia_Etapa (Configuración del flujo del proceso)

-- === PENAL ===
-- Indagación -> Imputación -> Acusación -> Juicio -> Sentencia -> Impugnación
...
INSERT INTO Especia_Etapa (codEspecializacion, pasoEtapa, codEtapa, idImpugna, nInstancia) VALUES ('PEN', 6, 'TIM', 'AP', 2); -- Sube a 2da instancia

-- === CIVIL ===
-- Demanda -> Contestación -> Audiencia -> Pruebas -> Sentencia -> Impugnación
...
-- === LABORAL ===
-- Demanda -> Audiencia -> Pruebas -> Sentencia -> Impugnación
...
-- === ADMINISTRATIVO ===
-- Demanda -> Contestación -> Pruebas -> Sentencia -> Impugnación
...
-- === TUTELA ===
-- Presentación -> Trámite urgente -> Fallo -> Impugnación
...
VALUES ('CLI01', 'CC', 'Juan', 'Pérez', '10101010'); -- El cliente del caso hipotético
...
-- Insertar datos de contacto para Juan Pérez (necesario por la tabla Contacto)
...
VALUES ('80001', 'Saul', 'Goodman', 'TP001'); -- Abogado defensor caso hipotético
...
-- Relacionar Abogado con Especialización (Tabla Especializacion_Abogado)
...
/* ==============================================================
   4. CASO HIPOTÉTICO (REQUERIMIENTO 2.6)
   Caso: Juan Pérez - Hurto Agravado
   ============================================================== */

-- 1. Crear el CASO (Cabecera)
-- Cliente: Juan Pérez (CLI01), Especialización: Penal (PEN)
...
-- Hito 1: Indagación (Fiscalía recopila pruebas)
...
-- Agregar un Suceso (Descripción de hechos) para Hito 1
INSERT INTO Suceso (codEspecializacion, pasoEtapa, nCaso, consecExpe, conSuceso, descSuceso)
VALUES ('PEN', 1, 1001, 1, 1, 'Captura de Juan Pérez por presunto hurto de celular. Apertura de investigación.');

-- Hito 2: Imputación (Ante Juez de Garantías)
INSERT INTO Expediente (codEspecializacion, pasoEtapa, nCaso, consecExpe, codLugar, cedula, fechaEtapa) 
VALUES ('PEN', 2, 1001, 2, 'JG001', '80001', TO_DATE('2025-10-05', 'YYYY-MM-DD'));

INSERT INTO Suceso (codEspecializacion, pasoEtapa, nCaso, consecExpe, conSuceso, descSuceso)
VALUES ('PEN', 2, 1001, 2, 1, 'Audiencia de imputación de cargos. El cliente NO acepta cargos.');

-- Hito 3: Acusación (Ante Juez de Conocimiento)
INSERT INTO Expediente (codEspecializacion, pasoEtapa, nCaso, consecExpe, codLugar, cedula, fechaEtapa) 
VALUES ('PEN', 3, 1001, 3, 'JG002', '80001', TO_DATE('2025-10-20', 'YYYY-MM-DD'));

INSERT INTO Suceso (codEspecializacion, pasoEtapa, nCaso, consecExpe, conSuceso, descSuceso)
VALUES ('PEN', 3, 1001, 3, 1, 'Fiscalía presenta escrito de acusación y pruebas documentales.');
...
-- Hito 5: Sentencia (Primera Instancia - Condenatoria, lo que motiva la apelación)
INSERT INTO Expediente (codEspecializacion, pasoEtapa, nCaso, consecExpe, codLugar, cedula, fechaEtapa) 
...
-- Hito 6: Apelación (Segunda Instancia - Tribunal)
-- Según el caso hipotético, el abogado no está de acuerdo y apela la sentencia
INSERT INTO Expediente (codEspecializacion, pasoEtapa, nCaso, consecExpe, codLugar, cedula, fechaEtapa) 
VALUES ('PEN', 6, 1001, 6, 'TRI01', '80001', TO_DATE('2025-11-25', 'YYYY-MM-DD'));

INSERT INTO Suceso (codEspecializacion, pasoEtapa, nCaso, consecExpe, conSuceso, descSuceso)
VALUES ('PEN', 6, 1001, 6, 1, 'Defensa radica recurso de apelación ante el Tribunal Superior.');
